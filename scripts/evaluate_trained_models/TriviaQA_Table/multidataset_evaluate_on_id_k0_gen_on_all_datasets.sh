...
rank=32
runnames=(
    TriviaQA_Alpha_Model_gemma-3-27b-it_v5
    TriviaQA_Alpha_Model_Llama-3.1-8B-Instruct_v5
    TriviaQA_Alpha_Model_Meta-Llama-3-70B-Instruct_supplement_v5
    TriviaQA_Alpha_Model_Qwen2.5-3B-Instruct_v5
    TriviaQA_Alpha_Model_Qwen2.5-7B-Instruct_v5
    TriviaQA_Alpha_Model_Qwen2.5-32B-Instruct_v5
    TriviaQA_Alpha_Model_Qwen2.5-72B-Instruct_v5
    TriviaQA_Alpha_Model_Qwen3-8B_supplement_v5
)
k_retrieves=(0)
...
do
    ...
    do
        ...
        do
            tunename="${model_to_eval}_${dataset}_k${k_retrieve}_eval_only_id_alldatasets_v2"
